...
@section('content')
    <div class="row tm-row">
        <div class="col-12">
            <hr class="tm-hr-primary tm-mb-55"> I
            <img src="{{-asset('storage/'.$post->image) }}" width="954" height="335">
        </div>
    </div>
        ...
        <div class="col-lg-8 tm-post-col">
            <div class="tm-post-full">
                ...
                <div>
                    ...
                    <div>
                        <p>
                            Praesent aliquam ex vel lectus ornare tritique. Nunc et eros quis enim feugiat tincidunt et vitae dui. Nullam consectetur justo ac ex laoreet rhoncus. Nunc id leo pretium, faucibus sapien vel, euismod turpis. I
                        </p>
    ...
    <aside class="col-lg-4 tm-aside-col">
        <div class="tm-post-sidebar">
           ...
           <ul class="tm-mb-75 p1-5 tm-category-list">
            ...
            <a href="#" class="d-block tm-mb-40">        
                <figure>    
                    ...
                    <figcaption class="tm-color-primary">Integer quis lectus eget justo ullamcorper</figcaption>
                </figure>
            </a>
            <a href="#" class="d-block tm-mb-40">        
                <figure>    
                    <img src="img/img-05.jpg" alt="Image" class="mb-3 img-fluid">
                    <figcaption class="tm-color-primary">Nam lobortis nunc faucibus commodo</figcaption>
                </figure>
            </a>
        </div>
    </aside>    
